...
class RequestHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if self.loc_db_mngr.connect(settings.local_db_path + "a.psdsd") is not None:
        ...
        try:
            ...
            if self.checkPathIsNotValid(sub_paths, 1):
                html_bytes = self.getFileText("../html/main.html")
            ...
            ####
                ...
                if self.checkPathIsNotValid(sub_paths, 2):
                    ...
                    html_bytes = self.getFileText("../html/css/style.css")
            ...
            ####
                ...
                if self.checkPathIsNotValid(sub_paths, 2):
                    ...
                    html_bytes = self.getFileText("../html/scripts/script.js")
    ...
    def getPageNotFound(self) -> (int, bytes):
        ...
        return 404, open("../html/404.html", "r").read().encode()

    def getWochenStatusPage(self) -> bytes:
        # Lade HTML TEMPLATE für Wochenstatus mit Javascript Chart
        html_string = self.getFileText("../html/wochenstatus.html")
        scan_list = [0] * 7
